...
def BackgroundForeground(image_file, cv_client):
    ...
    analysis_options.segmentation_mode = sdk.ImageSegmentationMode.BACKGROUND_REMOVAL# background
    # analysis_options.segmentation_mode = sdk.ImageSegmentationMode.FOREGROUND_MATTING#FOREGROUND
    image_analyzer = sdk.ImageAnalyzer(cv_client, image, analysis_options)
